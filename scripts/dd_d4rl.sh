...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=0 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=1 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=2 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=3 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=4 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=7 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=5 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
...
# inference
# mode="inference"
# CUDA_VISIBLE_DEVICES=6 nohup python -m pipelines.decision_diffuser.dd_d4rl task.env_name=$env_name mode=$mode diffusion_ckpt=$training_steps invdyn_ckpt=$invdyn_training_steps solver=ddpm sampling_steps=10 num_envs=50 num_episodes=3 > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
