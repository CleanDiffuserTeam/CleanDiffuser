...
CUDA_VISIBLE_DEVICES=0 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="halfcheetah-medium-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=1 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="halfcheetah-medium-replay-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=2 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="halfcheetah-medium-expert-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=3 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="hopper-medium-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=4 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="hopper-medium-replay-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=5 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="hopper-medium-expert-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=6 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="walker2d-medium-v2"
...
mode="critic_training"
critic_gradient_steps=50000
CUDA_VISIBLE_DEVICES=7 nohup python -m pipelines.sfbc.sfbc_d4rl task.env_name=$env_name mode=$mode eval_actor_ckpt=$bc_training_steps critic_gradient_steps=$critic_gradient_steps > logs/${mode}_${pipeline_name}_${env_name}.log 2>&1 &
# inference
# mode="inference"
# env_name="walker2d-medium-replay-v2"
