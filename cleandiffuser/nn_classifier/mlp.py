...
from cleandiffuser.nn_classifier.base_nn_classifier import BaseNNClassifier
...
class QGPONNClassifier(BaseNNClassifier):
    ...
    def __init__(
        ...
        self.mlp = Mlp(in_dim=3 * emb_dim, hidden_dims=hidden_dims, out_dim=1, activation=nn.SiLU())
