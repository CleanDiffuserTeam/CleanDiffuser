...
#             "next_obs": {"state": next_state_normalizer},
...
# def _data_to_obs(
#     raw_obs, raw_actions, rewards, next_raw_obs, dones, obs_keys, abs_action, rotation_transformer
# ):
#     # for key in obs_keys:
...
#     next_obs = np.concatenate([next_raw_obs[key] for key in obs_keys], axis=-1).astype(np.float32)
