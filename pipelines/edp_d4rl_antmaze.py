...
@hydra.main(config_path="../configs/edp/antmaze", config_name="antmaze", version_base=None)
def pipeline(args):
    ...
    actor = DiscreteDiffusionSDE(
        nn_diffusion, nn_condition, predict_noise=False, optim_params={"lr": args.actor_learning_rate},
    ...
    if args.mode == "train":
        ...
        for batch in loop_dataloader(dataloader):
            ...
            next_act, _ = actor.sample(
                ...
                n_samples=args.batch_size * 10, sample_steps=args.sampling_steps, use_ema=True,
                temperature=1.0, condition_cfg=next_obs_rpt, w_cfg=1.0, requires_grad=False)
            ...
            # EDP Action Approximation Technique
