...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, qpos_dim, env_state_dim, action_dim, num_queries, camera_names):
        """ Initializes the model.
        Parameters:
            backbones: torch module of the backbone to be used. See backbone.py
            transformer: torch module of the transformer architecture. See transformer.py
            qpos_dim: proprio state dimension
            env_state_dim: env state dimension
    ...
    def forward(self, qpos, image=None, env_state=None, actions=None, is_pad=None):
        """
        qpos: batch, qpos_dim
        image: batch, num_cam, channel, height, width
        env_state: batch, env_state_dim
        ...
        return a_hat, is_pad_hat, [mu, logvar], latent_sample
